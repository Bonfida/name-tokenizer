//! Instruction created in anticipation of free renewals
...
pub struct Accounts<'a, T> {
    ...
    /// The renew authority (PDA of the SNS Registrar)
    #[cons(writable, signer)]
    pub renew_authority: &'a T,
...
impl<'a, 'b: 'a> Accounts<'a, AccountInfo<'b>> {
    pub fn parse(
        ...
        let accounts = Accounts {
            ...
            renew_authority: next_account_info(accounts_iter)?,
        ...
        // Check keys
        // TODO: Add renew_authority check
        ...
        // Check signer
        check_signer(accounts.renew_authority)?;
...
pub fn process(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
    ...
    invoke_signed(
        ...
        &[
            ...
            accounts.renew_authority.clone(),
    ...
    core_record.owner = *accounts.central_state.key;
